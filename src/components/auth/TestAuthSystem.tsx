  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Test the unified role-based authentication system with these
          pre-configured accounts.
          <br />
          <strong>Note:</strong> You'll need to sign up these accounts first,
          then sign in.
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
          ...
          <ul className="text-sm text-yellow-700 dark:text-yellow-300 space-y-1">
            <li>
              <strong>User:</strong> → Main Dashboard (/)
            </li>
            <li>
              <strong>Admin:</strong> → Admin Dashboard (/admin/dashboard)
            </li>
          </ul>
        </div>
      </CardContent>
